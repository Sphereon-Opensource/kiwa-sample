...
curl -u "$KIWA_REPO_USER:$KIWA_REPO_PASSWORD" \
  -O "https://nexus.sphereon.com/repository/kiwa-snapshots/com/sphereon/kiwa/kiwa-sdk-ios/0.14.0-SNAPSHOT/kiwa-sdk-ios-0.14.0-SNAPSHOT.zip"

unzip kiwa-sdk-ios-0.14.0-SNAPSHOT.zip
```
