 ...
 */
interface IMdocInformationRequestPresenter : MoleculePresenter<IMdocInformationRequestPresenter.Input, IMdocInformationRequestPresenter.Model> {
    ...
    data class DocRequestSection(
        ...
        val cards: List<ICredentialCardPresenter.Model>,
