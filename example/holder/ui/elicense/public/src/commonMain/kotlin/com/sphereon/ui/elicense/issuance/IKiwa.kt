...
interface IKiwaWalletService {
    val services: IKiwaServices

    suspend fun getElicenses(): IssueLicenseResult
    suspend fun ensureWalletCertificate(alias: String = KIWA_WALLET_CERT_ALIAS): Certificate
    suspend fun assignElicense(code: String): IssueLicenseResult
}
