...
actual fun kottageEnvironment(app: App): KottageEnvironment {
    return KottageEnvironment(contextOf(app.application as Context))
}
...
actual fun kottage(
    ...
    return Kottage(
        kottageName,
        directoryPath ?: (app.application as Context).filesDir.path,
        environment ?: kottageEnvironment(app),
        scope
    )
}
