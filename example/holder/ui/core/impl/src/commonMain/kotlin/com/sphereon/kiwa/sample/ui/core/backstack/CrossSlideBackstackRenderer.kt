...
import com.sphereon.kiwa.sample.ui.core.backstack.CrossSlideBackstackPresenter.Model
...
class CrossSlideBackstackRenderer(private val rendererFactory: RendererFactory) :
    ...
    private fun <T : Any> CrossSlide(
        ...
        val direction: Int = if (reverseAnimation) {
            -1
        } else {
            1
        }
                    ...
                    SlideInOutAnimationState(key, state) {
                        ...
                        Box(
                            modifier.graphicsLayer {
                                this.translationX = if (transition.targetState == key) {
