 ...
 */
interface ICredentialListItemPresenter : MoleculePresenter<ICredentialListItemPresenter.Input, ICredentialListItemPresenter.Model> {
    @Immutable
    sealed interface Input {
        @Immutable
        data class Row(
            val card: ICredentialCardPresenter.Input,
